...
3. **📅 Module 1 — Procurement Schedule & Official Government MSP Engine**:
   - **Official CACP Schedule**: Sourced directly from Commission for Agricultural Costs and Prices (CACP), Ministry of Agriculture & Farmers Welfare ([cacp.da.gov.in/Home/MSP](https://cacp.da.gov.in/Home/MSP)).
   - **Comprehensive 28 Commodities**: Covers all official Kharif (2026-27), Rabi, and Commercial crops with Fixed MSP (₹/Qtl), Recommended rates (Rec), and YoY hike metrics.
   - **Multi-Year Price History (2018–2027)**: Interactive comparative table analyzing historical MSP progression across marketing years.
   - **Dynamic Live Govt Sync (`cacp.da.gov.in/json.json`)**: Real-time sync engine that fetches and applies fresh government MSP announcements instantly with full offline caching.
   - **Ministry Gazette Announcement & Revision Desk**: Built-in modal enabling portal administrators/officers to publish newly notified CCEA MSP revisions and mid-season bonuses that instantly cascade across all registration forms, assaying slips, and DBT payouts.
   - **Statutory CACP Footnotes & Norms**: Integrated accordion containing all 15 official policy footnotes (bonus eligibility, moisture limits, staple lengths, and sugarcane FRP recovery standards).
